...
gcloud run services update "$SERVICE_NAME" \
  --project "$PROJECT_ID" \
  --region "$REGION" \
  --update-secrets "LWA_CLIENT_ID=$LWA_CLIENT_ID_SECRET:latest,LWA_CLIENT_SECRET=$LWA_CLIENT_SECRET_SECRET:latest,$REFRESH_ENV=$LWA_REFRESH_SECRET:latest,AWS_ACCESS_KEY_ID=<PUT_YOUR_AWS_ACCESS_KEY_ID_SECRET>:latest,AWS_SECRET_ACCESS_KEY=<PUT_YOUR_AWS_SECRET_ACCESS_KEY_SECRET>:latest" \
